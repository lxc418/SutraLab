...
fprintf(fid,' %.4E\t%.4E\t%.4E\t%.4E\t%.4E\t%.4E\t%.4E\n',o.compfl,o.cw,o.sigmaw,o.rhow0,o.urhow0,o.drwdu,o.visc0);
...
fprintf(fid,' %.4E\t%.4E\t%.4E\t%.4E\t%.4E\t%.4E\t%.4E\t%.4E\t%.4E\t%.4E\t%.4E\t%.4E\t%.4E\t%.4E\n',...
    o.swres1,o.aa1,o.vn1,o.swres2,o.aa2,o.vn2,o.swres3,o.lam3,o.phyb3,o.swrea4,o.lam4,o.phyb4,o.phy0,o.ecto);
