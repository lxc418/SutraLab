...
%  o2.output_no             = output_no;
  if strcmpi(o.transpose,'no')
      if strcmpi(x_output,'yes')
        o.x_mtx=reshape(o.data(1).terms{o.x_idx},[o.ne1,o.ne2]);
      end
      if strcmpi(y_output,'yes')
        o.x_mtx=reshape(o.data(1).terms{o.y_idx},[o.ne1,o.ne2]);
      end
      if strcmpi(z_output,'yes')
        o.x_mtx=reshape(o.data(1).terms{o.z_idx},[o.ne1,o.ne2]);
      end
