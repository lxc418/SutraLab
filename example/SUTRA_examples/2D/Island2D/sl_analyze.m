...
c_matrix1 = reshape(nod(2).terms{c_idx},[inp.nn1,inp.nn2]); % Timestep 1
c_matrix100 = reshape(nod(3).terms{c_idx},[inp.nn1,inp.nn2]); % Timestep 100, 20 years
...
s_matrix1  = reshape(nod(2).terms{s_idx},[inp.nn1,inp.nn2]); % Timestep 1
s_matrix100  = reshape(nod(3).terms{s_idx},[inp.nn1,inp.nn2]); % Timestep 100
...
vx_matrix100 = reshape(ele(2).terms{vx_idx}*24*3600,[inp.nn1-1,inp.nn2-1]); % Timestep 100
...
vy_matrix100 = reshape(ele(2).terms{vy_idx}*24*3600,[inp.nn1-1,inp.nn2-1]); % Timestep 100
